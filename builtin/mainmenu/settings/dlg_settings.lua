...
local top_btns = {
	query_text = "ROllerozxa",
	get_formspec = function(self, avail_w)
		return ("button[0,0;3,0.8;btn_change_keys;%s]"):format(fgettext("Change keys"))
			.. ("button[3.1,0;3,0.8;btn_about;%s]"):format(fgettext("About")), 0.8
	end,
